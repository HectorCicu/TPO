...
<ul id="ul-hamburguesa">
  <li id="li-hamburguesa">Link 1</li>
  <li id="li-hamburguesa">Link 2</li>
  <li id="li-hamburguesa">Link 3</li>
  <li id="li-hamburguesa">Link 4</li>
</ul>
</div>`;
...
let pieDePagina = 
`  <div>&copy ${ANIO} -  Héctor Hugo Cicutti | Todos los derechos reservados</div>
`
...
registro.addEventListener("click", () => {
  let formularioIngreso = `<form class="form" id="nuevoUsuario"> 
      ...
      <div class="field">    
        ...
        <div class="field">
          ...
          <input placeholder="Repetir Contraseña" class="input-field" type="password" />
        </div>  
        <div class="btn">
          <button class="button1" id="button1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Registrarse&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          </button>
        </div>
  </form>`;
  ...
  let formulario = `<form class="form">
     <p id="heading">Ingreso</p>
        <div class="field">
         ...
         <div class="btn">
           <button class="button1" id="button1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Ingresar&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
           </button>
           <button class="button3">Olvidó su Contraseña?
           </button>
         </div>
  </form>`;
...
/** contenido del ASIDE cuando recién se ingresa */
